...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { name: @discipline.name, semester: @discipline.semester, teacher: @discipline.teacher } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { name: @discipline.name, semester: @discipline.semester, teacher: @discipline.teacher } }
