...
ActiveRecord::Schema.define(version: 20181206192534) do
  ...
  create_table "disciplines", id: false, force: :cascade do |t|
    ...
    t.index ["group_id"], name: "index_disciplines_on_group_id"
  end
  ...
  create_table "teaching_materials", force: :cascade do |t|
    ...
    t.index ["group_id"], name: "index_teaching_materials_on_group_id"
  end
